-- Smart Production für Trockenofen
DROP DATABASE MES;
...
INSERT INTO MES.PARTS (PART_ID, RFID, COLOR_ID, PART_STATE) VALUES (1, 1, 2, 0);
INSERT INTO MES.PARTS (PART_ID, RFID, COLOR_ID, PART_STATE) VALUES (2, 2, 2, 0);
INSERT INTO MES.PARTS (PART_ID, RFID, COLOR_ID, PART_STATE) VALUES (3, 3, 2, 0);

INSERT INTO MES.STOCKYARDS (STOCKYARD_ID, PART_ID) VALUES (1, 1);
INSERT INTO MES.STOCKYARDS (STOCKYARD_ID, PART_ID) VALUES (2, 0);
INSERT INTO MES.STOCKYARDS (STOCKYARD_ID, PART_ID) VALUES (3, 2);
INSERT INTO MES.STOCKYARDS (STOCKYARD_ID, PART_ID) VALUES (4, 0);
INSERT INTO MES.STOCKYARDS (STOCKYARD_ID, PART_ID) VALUES (5, 3);
...
INSERT INTO MES.VARIANTS (VARIANT_ID, NAME) VALUES (1, 'lange und heiss trocknen');
INSERT INTO MES.VARIANTS (VARIANT_ID, NAME) VALUES (2, 'kurz und gut');

INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (1, 1, 1, 1, NULL, NULL);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (3, 2, 1, 4, 35, 10);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (4, 3, 1, 1, NULL, NULL);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (5, 1, 2, 1, NULL, NULL);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (7, 2, 2, 4, 45, 15);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (8, 3, 2, 1, NULL, NULL);
...
INSERT INTO MES.ORDERS (ORDER_ID, PRODUCT_ID, COLOR_ID, VARIANT_ID, CUSTOMER_ID, ORDER_STATE, PART_ID) VALUES (4712, 1, 2, 2, 1, 0, NULL);
INSERT INTO MES.ORDERS (ORDER_ID, PRODUCT_ID, COLOR_ID, VARIANT_ID, CUSTOMER_ID, ORDER_STATE, PART_ID) VALUES (4713, 1, 2, 1, 2, 0, NULL);
INSERT INTO MES.ORDERS (ORDER_ID, PRODUCT_ID, COLOR_ID, VARIANT_ID, CUSTOMER_ID, ORDER_STATE, PART_ID) VALUES (4714, 1, 2, 2, 3, 0, NULL);
