...
INSERT INTO MES.MACHINES (MACHINE_ID, NAME, NAME_PARA1, NAME_PARA2) VALUES (2, 'Klimakammer', 'Temperatur', 'Trockenzeit');
INSERT INTO MES.MACHINES (MACHINE_ID, NAME, NAME_PARA1, NAME_PARA2) VALUES (3, 'QS', '', '');
...
INSERT INTO MES.VARIANTS (VARIANT_ID, NAME) VALUES (1, 'heiss und kurz');
INSERT INTO MES.VARIANTS (VARIANT_ID, NAME) VALUES (2, 'warm und lang');

INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (1, 1, 1, 1, NULL, NULL);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (2, 2, 1, 2, 45, 5);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (3, 3, 1, 3, NULL, NULL);
...
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (6, 2, 2, 2, 35, 15);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (7, 3, 2, 3, NULL, NULL);
